...
declare -a RECIPES=("./recipes/coding_horror.recipe" "./recipes/xkcd.recipe")
declare -a NAMES=("Coding_Horror" "XKCD")
OUTDIR="./converted"
...
do
	...
	ebook-convert "${RECIPES[$i]}" "$OUTFILE" --output-profile "$OUTPROFILE" --no-inline-toc
